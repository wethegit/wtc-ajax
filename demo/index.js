...
},{"../src/wtc-ajax":301}],2:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":4,"core-js/shim":297,"regenerator-runtime/runtime":3}],3:[function(require,module,exports){
...
},{"_process":298}],4:[function(require,module,exports){
...
var AJAX = function (_History) {
  ...
  _createClass(AJAX, null, [{
    ...
    value: function ajaxGet(URL, target, selection, linkTarget) {
      ...
      // Dev mode output
      if (this.devmode) {
        var animationTime = detectAnimationEndTime(DOMTarget, this.animationDepth);
      ...
      then(function (resolver) {
        ...
        // Add the animation end listener to the target node
        if (this.devmode) {
          var _animationTime = detectAnimationEndTime(targetNode);
          console.warn("Animation in time is: " + _animationTime);
        }
    ...
    value: function _completeTransfer(content, target, selection, fromPop) {
      ...
      try {
        for (var _iterator2 = content.subdoc[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
},{"./wtc-AnimationEvents":300,"./wtc-history":302,"babel-polyfill":2,"wtc-utility-helpers":299}],302:[function(require,module,exports){
'use strict';
